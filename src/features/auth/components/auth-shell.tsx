  ...
  return (
    <>
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className="relative min-h-screen overflow-hidden lg:grid lg:grid-cols-[0.95fr_1.05fr]"
      >
        <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_10%_15%,rgba(124,58,237,0.12),transparent_30%),radial-gradient(circle_at_90%_85%,rgba(249,115,22,0.10),transparent_28%)]" />
